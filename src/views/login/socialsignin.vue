...
export default {
  ...
  methods: {
    wechatHandleClick(thirdpart) {
      ...
      const url = 'https://open.weixin.qq.com/connect/qrconnect?appid=' + appid + '&redirect_uri=' + redirect_uri +
    ...
    tencentHandleClick(thirdpart) {
      ...
      const redirect_uri = encodeURIComponent('xxx/redirect?redirect=' + window.location.origin + '/authredirect')
      const url = 'https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=' + client_id +
